    ...
    <div class="container cont" style="margin-top: 20px;">
        <div class="row">
            ...
            <div class="col-md-4 offset-md-4 form signup-form">
                ...
                <form action="customer_register.php" method="POST" autocomplete="">
                    <h2 class="text-center" style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">Register here!</h2><br>
                    ...
                    <div class="link login-link text-center">Already a member? <a class="font-weight-bold" href="customer_login.php">Login here</a></div>
                </form>
            </div>
        </div>
    </div>
